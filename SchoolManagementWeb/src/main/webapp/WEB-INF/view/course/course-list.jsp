				...
				<div class="main-content">
					<div class="dashboard-block mt-0">
						<div
							...
							<h3 class="block-title">Courses List <c:out value="${course.name}" /></h3>
							<div class="form-group button mb-0">
								<a class="btn me-4"
									href="${pageContext.request.contextPath }/courses/new">New</a>
							</div>
						</div>
						<!-- <nav class="list-nav">
							<ul>
						...
						<div class="my-items">
							<div class="item-list-title">
								<div class="row align-items-center">
									...
									<div class="col-lg-4 col-md-4 col-12 align-right">
										<p>Action</p>
									</div>
								</div>
							</div>
							...
							<c:forEach var="course" items="${listCourse}">
								<div class="single-item-list">
									<div class="row align-items-center">
										...
										<div class="col-lg-4 col-md-4 col-12">
											<p>
												<c:out value="${course.program}" />
											</p>
										</div>
										<div class="col-lg-4 col-md-4 col-12 align-right">
											<ul class="action-btn">
												<li><a
													href="courses/edit?id=<c:out value='${course.id}' />">
												...
												<li><a href="#" onClick="if(!confirm('Etes vous surs?')) return false; document.getElementById('form-delete').submit()">
													...
													<form id="form-delete" method="post" action="courses/delete" class="d-inline d-none">
